...
def cmdprint(astrastring):
	...
	print('Background key:          '+astrastring['backkey'])
	print('\n================================================\n')
...
# Preallocating needed variables
...
suggflag  = 0																	# todo NEEDS DESCRIPTION
errorflag = 0																	# todo NEEDS DESCRIPTION
...
#====File saving================================================================
if errorflag == 0 and savingflag == 1:
...
#====Plotting===================================================================
if errorflag == 0 and plottingflag == 1:
